...
RUN chmod +x /install_packages && sed -i 's|http://deb.debian.org|https://deb.debian.org|g' /etc/apt/sources.list && apt-get update -o Acquire::AllowInsecureRepositories=false || true
